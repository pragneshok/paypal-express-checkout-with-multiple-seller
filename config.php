...
$api_username 		= 'Keyur.Joshi-facilitator_api1.imobdevtech.com'; //PayPal API Username
$api_password 		= '1370586731'; //Paypal API password
$api_signature 		= 'An5ns1Kso7MWUdW4ErQKJJJ4qi4-AXQejVf2IZobXvy9KwoTwVAMtxFn'; //Paypal API Signature
